...
const Learing = () => {
   ...
   return (
    <div className='max-w-6xl mx-auto my-5'>
        ...
        <p className='text-md font-normal text-center text-balance'>Boost your learning by setting clear goals, staying consistent practicing daily,<br /> and reflecting on your progress.</p>
     <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 ml-2'>
        {
            data.map(learn=> <div key={learn.id} className='my-10 space-y-3  px-6 py-6  bg-gradient-to-b from-blue-200 to-red-100 rounded-xl shadow-lg'>
                <img className='h-35 w-80 rounded-xl' src={learn.img} alt="" />
