...
const Story = ({story}) => {
    console.log(story)
    return (
        <div className='block mx-auto md:flex md:gap-10 my-5 p-5 rounded-xl shadow-xl bg-gradient-to-l from-blue-100 to-red-50' >
            <div>
                <img className=' block mx-auto md:w-45 h-30 object-cover rounded-xl' src={story.img_url} alt="" />
            </div>
            <div className='space-y-2'>
                <h1 className='font-semibold text-lg text-center md:text-start mt-0.5'>{story.name}</h1>
